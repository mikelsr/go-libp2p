...
import (
	...
	tmux "github.com/mikelsr/go-libp2p/p2p/muxer/testsuite"
)
...
func TestDefaultTransport(t *testing.T) {
	...
	delete(tmux.Subtests, "github.com/mikelsr/go-libp2p-testing/suites/mux.SubtestStress1Conn1000Stream10Msg")
