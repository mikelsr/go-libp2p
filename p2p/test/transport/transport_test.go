...
import (
	...
	"github.com/mikelsr/go-libp2p/config"
	...
	"github.com/mikelsr/go-libp2p/p2p/muxer/yamux"
	"github.com/mikelsr/go-libp2p/p2p/protocol/ping"
	"github.com/mikelsr/go-libp2p/p2p/security/noise"
	tls "github.com/mikelsr/go-libp2p/p2p/security/tls"
...
func TestLotsOfDataManyStreams(t *testing.T) {
	// Skip on windows because of https://github.com/mikelsr/go-libp2p/issues/2341
	if runtime.GOOS == "windows" {
		t.Skip("Skipping on windows because of https://github.com/mikelsr/go-libp2p/issues/2341")
	}
