...
a remote execution exploit -- please [**report privately**](https://github.com/mikelsr/go-libp2p/security/advisories/new).
...
For non-security bugs, please simply file a GitHub [issue](https://github.com/mikelsr/go-libp2p/issues/new).
